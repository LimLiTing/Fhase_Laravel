    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item <?php echo e(($segment1 == 'userProfile' || $segment1 == 'editProfile') ? 'active open' : ''); ?> has-sub">
                    <a href="#"><i class="ik ik-user-check"></i><span><?php echo e(__('User')); ?></span></a>
                    <div class="submenu-content">
                        <!-- Display Profile -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_profile')): ?>
                        <a href="<?php echo e(url('userProfile')); ?>" class="menu-item <?php echo e(($segment1 == 'userProfile') ? 'active' : ''); ?>"><?php echo e(__('User Profile')); ?></a>
                         <?php endif; ?>
                         <!-- Edit Profile -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_edit')): ?>
                        <a href="<?php echo e(url('editProfile')); ?>" class="menu-item <?php echo e(($segment1 == 'editProfile') ? 'active' : ''); ?>"><?php echo e(__('Edit Profile')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="nav-item <?php echo e(($segment1 == 'pos') ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\FhaseProjects\Main_File\resources\views/include/sidebar.blade.php ENDPATH**/ ?>