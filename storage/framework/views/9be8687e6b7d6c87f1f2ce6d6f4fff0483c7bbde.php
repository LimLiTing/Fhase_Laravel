                ...
                <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                    <div class="authentication-form mx-auto">
                        <div class="logo-centered">
                            <a href="http://radmin.rakibhstu.com"><img height="40" src="<?php echo e(asset('img/logo.png')); ?>"
                                    alt="RADMIN"></a>
                        </div>
                        <p>Welcome back! </p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div style="text-align: center; background-color: skyblue; padding: 10px; border-radius: 10px; margin-top:20px">
                                <a href="<?php echo e(url('auth/facebook')); ?>" style="color: white;">
                            ...
                            <div style="text-align: center; background-color: darkblue; padding:10px; border-radius: 10px; margin-top:20px">
                                <a href="<?php echo e(url('auth/google')); ?>" style="color: white;">
    ...
    <!-- <script type="text/javascript" src="<?php echo e(url('public/js/firebase-conf.js')); ?>"></script> -->
</body>

</html><?php /**PATH D:\FhaseProjects\Main_File\resources\views/auth/login.blade.php ENDPATH**/ ?>